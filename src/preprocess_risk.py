"""
Step 3a: Preprocessing - Risk Module (thyroid_cancer_risk_data.csv)
Purpose: Encode categoricals, scale continuous features, split data,
save encoders/scalers for later use in the backend API.
