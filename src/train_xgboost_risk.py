...
Purpose: Train XGBoost (a strong tree-based ML algorithm) as a STRONGER
baseline than Logistic Regression, for the Risk dataset (Diagnosis target).
Tabular data (like our CSV) often works very well with XGBoost, so this
gives a fair, tough comparison point for our deep learning model later.
"""
import numpy as np
