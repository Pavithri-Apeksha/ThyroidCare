...
Purpose: Train a simple baseline model (Logistic Regression) on the Recurrence dataset, for later comparison against the deep learning model.
"""
import numpy as np
...
# Save the model for comparison later
